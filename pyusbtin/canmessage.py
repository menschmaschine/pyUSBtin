...
class CANMessage(object):
	...
	timestamp : int
		message time stamp; default 0
	"""

	dbc_info = {}

	def __init__(self, mid, data=None, rtr=False, name='', dlc=None, timestamp=0):
	...
	def from_string(cls, msg):
		...
		Example message strings:
		   t12308D5F        id: 123h        dlc: 0      data: --	timestamp: 36191
		   t001211228D5F    id: 001h        dlc: 2      data: 11 22	timestamp: 36191
		   T123456781978D5F id: 12345678h   dlc: 1      data: 97	timestamp: 36191
		   r00378D5F        id: 003h        dlc: 7      RTR			timestamp: 36191
		   
		Note: 
		The timestamp wraps around every 60 seconds
		...
		if msg:
			...
			if mtype == 'r':
				...
				for i in range(dlc):
					...
					index += 2		
			timestamp = int(msg[index:], 16)
			return cls(mid, data=data, dlc=dlc, rtr=rtr, timestamp=timestamp)
		else:
			mid = 0
			dlc = 0
